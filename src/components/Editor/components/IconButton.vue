...
<script>
// 工具栏图标集合
const toolbarPathNameMap = {
  undo: '<path d="M15 8a5 5 0 010 10H6v-1.5h9a3.5 3.5 0 003.495-3.308L18.5 13A3.5 3.5 0 0015 9.5H6V8h9z"></path><path d="M7.8 6v5.5L4.5 8.75z"></path>',
  redo: '<path d="M10 8a5 5 0 000 10h9v-1.5h-9a3.5 3.5 0 01-3.495-3.308L6.5 13A3.5 3.5 0 0110 9.5h9V8h-9z"></path><path d="M16.7 6v5.5L20 8.75z"></path>',
  formatBrush:
  ...
  bold: '<path d="M11.75 5a3.75 3.75 0 010 7.5H8V5h3.75zm0 1.5H9.5V11h2.25a2.25 2.25 0 100-4.5z"></path><path d="M13 11a4 4 0 110 8H8v-8h5zm0 1.5H9.5v5H13a2.5 2.5 0 100-5z"></path>',
...
export default {
  ...
  computed: {
    pathName() {
      return toolbarPathNameMap[this.name]
    },
  },
}
</script>
